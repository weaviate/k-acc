                    ...
                    {review.img ? (
                        <div className="border bg-secondary rounded-lg shadow-sm">
                            ...
                            <div className="flex flex-col p-4">
                                <p className="text-primary text-md font-outfit">{review.title}</p>
                                <p className="text-gray-700 text-sm font-outfit">{review.comment}</p>
                            </div>
                            <div className="flex flex-col items-left justify-left mb-4 px-4">
                                <div className="text-xs text-primary opacity-50">{review.date}</div>
                                <div className="text-xs text-primary opacity-50">By {review.author}</div>
                            </div>
                        </div>
                    ) : (
                        <div className="border bg-secondary rounded-lg shadow-sm">
