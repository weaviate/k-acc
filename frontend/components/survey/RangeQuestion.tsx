...
const RangeQuestion: React.FC<RangeQuestionProps> = ({
    ...
    const [value, setValue] = useState<number>(existingAnswer ? parseInt(existingAnswer) : 3);
        ...
        <div className="min-h-screen relative p-6">
            ...
            <div className="flex flex-col items-center justify-center gap-8 max-w-2xl mx-auto pt-10">
                ...
                <div className="w-full max-w-xl">
                    ...
                    <div className="w-full flex justify-between text-primary/50 text-sm mt-4 px-7">
