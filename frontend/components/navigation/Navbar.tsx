            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        ...
                        <li><a onClick={() => router.push("/search")}>Shop all</a></li>
                        <li>
                            <a onClick={() => window.open("https://weaviate.io/", "_blank")}>About Weaviate</a>
                        </li>
                        <li><a onClick={() => router.push("/survey")}>Survey</a></li>
                    </ul>
                </div>
                <img src="/logo.svg" alt="Logo" className="h-6 ml-3 hidden lg:block cursor-pointer" onClick={() => router.push("/")}/>
            </div>
            <div className="navbar-center hidden lg:flex text-primary">
                <ul className="menu menu-horizontal px-1">
                    <li><a className="hover:bg-secondary" onClick={() => router.push("/search")}>Shop all</a></li>
                    <li><a className="hover:bg-secondary" onClick={() => window.open("https://weaviate.io/", "_blank")}>About Weaviate</a></li>
                    <li><a className="hover:bg-secondary" onClick={() => router.push("/survey")}>Survey</a></li>
                </ul>
            </div>
